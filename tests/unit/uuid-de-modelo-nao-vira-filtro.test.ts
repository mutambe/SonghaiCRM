 ...
 *
 * ═══ O defeito, medido em produção (upstream, adoptado aqui) ════════════════
 *
 ...
 *
 * Porque o campo não tem nada de especial. Medido no catálogo inteiro: dezenas
 * de campos de uuid aceitam ausência, e ANTES do conserto todos vazavam a
 * mesma sentinela. Consertar por instância deixaria o próximo campo nascer
 * fora. Esta guarda pergunta a propriedade a TODO o catálogo, e a pergunta é
 * feita ao SCHEMA.
 *
 ...
 * nomeada que já existe e ensina o modelo. Guarda de borda não decide negócio.
 */
